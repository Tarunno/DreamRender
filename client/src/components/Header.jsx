  ...
  return (
    <div className='h-screen w-[300px] border-r border-gray-500 flex flex-col justify-between fixed z-10'>
      ...
      <div className='flex items-center p-6 gap-1'>
        <img className='w-10 rounded-lg' src="./avater.webp" alt="avater" />
        <div>
          <p>Mahadi Hasan Taronno</p>
          <p className='text-gray-400'>@tarunno123</p>
        </div>
      </div>
    </div>
  )
